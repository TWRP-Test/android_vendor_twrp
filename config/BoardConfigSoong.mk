...
SOONG_CONFIG_twrpGlobalVars_tw_ozip_decrypt_key := $(TW_OZIP_DECRYPT_KEY)
SOONG_CONFIG_twrpGlobalVars_tw_no_fastboot_boot := $(TW_NO_FASTBOOT_BOOT)
...
SOONG_CONFIG_twrpGlobalVars_tw_input_blacklist := $(TW_INPUT_BLACKLIST)
SOONG_CONFIG_twrpGlobalVars_tw_whitelist_input := $(TW_WHITELIST_INPUT)
...
SOONG_CONFIG_twrpGlobalVars_tw_support_input_aidl_haptics_fqname := $(TW_SUPPORT_INPUT_AIDL_HAPTICS_FQNAME)
